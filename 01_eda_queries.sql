...
-- Q2.2: Detect impossible credit scores (max should be 850)
...
-- Q5.2: Volume + default rate together (portfolio concentration risk)
SELECT 
    Purpose,
    COUNT(*)                                                                AS Total_Loans,
...
-- ============================================================
-- END OF EDA
-- Summary of findings passed to 02_data_cleaning.sql
-- ============================================================
